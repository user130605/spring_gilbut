...
public class CommentService {
    ...
    public CommentDto update(Long id, CommentDto dto) {
        // 1. 댓글 조회 및 예외 발생
        Comment tartget = commentRepository.findById(id)                              // 수정할 댓글 가져오기
        ...
        // 3. DB로 갱신
        Comment updated = commentRepository.save(tartget);
    ...
    public CommentDto delete(Long id) {
        // 1. 댓글 조회 및 예외 발생
        Comment tartget = commentRepository.findById(id)                              // 삭제할 댓글 가져오기
